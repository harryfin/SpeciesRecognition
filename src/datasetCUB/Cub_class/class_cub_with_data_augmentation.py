...
class Cub2011_data_augmentation_for_training(Dataset):

    base_folder = "CUB_200_2011/images"

    def __init__(self, root, cub_data, preprocess_clip, preprocess_training, classes):
        """
    ...
    def __getitem__(self, idx):
        ...
        img_training = self.preprocess_training(img)

        return (img_clip, label), (img_training, label)
